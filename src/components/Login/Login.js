...
const Login = () => {
    ...
    return (
        ...
        <div className="container">
                  ...
                  <form action="" onSubmit={handleRegister} className="login_form">
                    ...
                    <div className="row mb-3 justify-content-center">
                      <div className="col-sm-10">
                        <input type="email" placeholder="Email" onBlur={handleUserName} className="form-control" id="inputEmail3"/>
                      </div>
                    </div>
                    <div className="row mb-3 justify-content-center">
                      <div className="col-sm-10">
                        <input type="password" placeholder="Password" onBlur={handlePassword} className="form-control" id="inputPassword3"/>
                      </div>
                    </div>
            ...
            <div className="row mb-3">
              <div className="col-sm-10 offset-sm-2">
                <div className="form-check">
                  <input className="form-check-input" onChange={handleCheckRegistered} type="checkbox" id="gridCheck1"/>
            ...
            <button type="submit" className="btn btn-primary login_btn">Sign {isLogin ? 'in' : 'up' }</button>
